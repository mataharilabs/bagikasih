			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<div class="radio">
						...
						<?php if(count($social_target) > 0):?>
						<label>{{ Form::radio('currency','IDR',$social_target->currency == 'IDR' ? true : '',['class' => 'radio']) }} IDR</label>
					<?php else: ?>
				...
				<div class="form-group">
					...
					<div class="radio">
						<?php if(count($social_target) > 0):?>
							<label>{{ Form::radio('status','0',$social_target->status == 0 ? true : '',['class' => 'radio']) }} Not Active</label>
							<label>{{ Form::radio('status','1',$social_target->status == 1 ? true : '',['class' => 'radio']) }} Active</label>
						<?php else:?>
				...
				<div class="box-body" id="voley">
					<table id="datatable" class="table table-bordered table-striped">
						<tbody>
							<tr>
								<th>Foto Utama</th>
								<td id="setphoto"><img src="{{ url('photos') }}/{{ $social_target->default_photo_id ? 'thumb_'.$social_target->default_photo_id : 'default' }}.jpg" class="img-polaroid img-rounded" style="max-width:150px;height:auto;"></td>
							</tr>
							<tr>
								<th>Foto Banner</th>
