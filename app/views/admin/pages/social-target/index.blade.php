				...
				<table id="datatable" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr{{ $class }}>
							...
							<td>{{ date('d M Y H:i', $social_target->created_at->timestamp) }}</td>
							<td>
								...
								<a href="{{ route('admin.social-target.delete', $social_target->id) }}" onclick="return confirm('Anda yakin..???');" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Hapus</a>
							</td>
						</tr>
						@endforeach
					</tbody>
