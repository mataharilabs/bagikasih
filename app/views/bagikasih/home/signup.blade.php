  ...
  <div class="modal-dialog">
    <div class="modal-content">
            ...
            <div class="form-group">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"  style="padding-bottom:5px;">
                <div class="input-group">
                  ...
                  <input class="form-control" id="firstname" name="firstname" type="text" placeholder="Nama Depan" value="{{ isset($firstname) ? $firstname : '' }}">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-edit fa-fw"></i></span>
                  <input class="form-control" id="lastname" name="lastname" type="text" placeholder="Nama Belakang" value="{{ isset($lastname) ? $lastname : '' }}">
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"  style="padding-bottom:5px;">
                <div class="input-group">
                  ...
                  <input class="form-control" id="email" name="email" type="text" placeholder="Alamat Email" value="{{ isset($email) ? $email : '' }}">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-phone fa-fw"></i></span>
                  <input class="form-control" id="phone_number" name="phone_number" type="text" placeholder="No. Telepon" value="{{ isset($phone_number) ? $phone_number : '' }}">
                </div>
              </div>
            </div>
            <div class="form-group">
      ...
      <div class="modal-footer">
        Sudah mempunyai akun? <a href="/login?redirect={{ $currenturl }}" data-toggle="modal" data-dismiss="modal">Log In</a>
      </div>
    </div>
  </div>
</div>
