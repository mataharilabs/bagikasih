...
{{ HTML::style('assets/components/owl-carousel/owl.carousel.css'); }}
{{ HTML::style('assets/components/bs-tour/css/bootstrap-tour.min.css'); }}
{{ HTML::script('assets/assets/js/jquery-1.10.1.min.js'); }}
{{ HTML::script('assets/components/owl-carousel/owl.carousel.min.js'); }}
