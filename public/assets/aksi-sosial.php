...
<div class="col-lg-6  col-md-6 col-sm-6 col-xs-12 text-left">
<p>Hello, <b>Rotary Club!</b></p>
<p>Anda akan donasi untuk aksi sosial:<br><b>Perbaikan Fasilitas Panti Vincentius</b></p>
                    </div>
                  </div>

                  <hr>Tentukan besar donasi anda kepada aksi sosial Perbaikan Fasilitas Panti Vincentius<p>
...
<!-- Headline - selesai-->
    ...
    <div class="swiper-container">
      <div class="swiper-wrapper">
        <div class="swiper-slide"> <img style="width:100%; height:100%;" class="img-polaroid img-rounded" src="assets/img/fundraiser/fund-1.jpg"> </div>
        <div class="swiper-slide"> <img style="width:100%; height:100%;" class="img-polaroid img-rounded" src="assets/img/fundraiser/fund-2.jpg"> </div>
      </div>
    </div>
...
Pada Event: <a href="event">Pertamina Bazzar Day</a></p>
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center">
              ...
              <p><a href="#myModal2" data-toggle="modal" class="btn btn-primary btn-lg" style="width:100%;"><i class="fa fa-gift fa-lg"></i> Beri Donasi</a></p> 
