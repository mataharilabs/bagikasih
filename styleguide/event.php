        ...
        <div class="row">
          <div class="col-lg-12"  align="center">
            ...
            <div class="page-header">
              <h2 id="navbar">Pertamina Bazzar Day</h2>
              <p><a href="temukan-event">Event</a></p>
            </div>
...
<!-- Headline - selesai-->
    ...
    <div class="swiper-container">
      <div class="swiper-wrapper">
        <div class="swiper-slide"> <img style="width:100%; height:100%;" class="img-polaroid img-rounded" src="assets/img/event/event-3.jpg"> </div>
        <div class="swiper-slide"> <img style="width:100%; height:100%;" class="img-polaroid img-rounded" src="assets/img/event/event-3.jpg"> </div>
      </div>
    </div>
...
Email:  asia@website.com</p>
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 text-center">
              ...
              <p><a href="" class="btn btn-primary btn-lg" style="width:100%;"><i class="fa fa-globe fa-lg"></i> Kunjungi Web</a></p>              
...
<div class="addthis_sharing_toolbox"></div>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="page-header">
              <h2 id="navbar">Daftar aksi sosial pada event Pertamina Bazzar Day</h2>
            </div>
