    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="http://www.bagikasih.com" class="navbar-brand"><img src="assets/img/logo.png"></a>          
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          ...
          <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="padding-top: 10px; padding-bottom: 10px;">Rotary Club <img class="img-rounded img-polaroid" src="assets/img/ava.png" width="30" height="30"></a>
                        <ul class="dropdown-menu">
                        <li><a href="rotary-club"><i class="fa fa-user fa-fw"></i> Profil Saya</a></li>
                        <li><a href="edit-profile"><i class="fa fa-pencil fa-fw"></i> Pengaturan Profil</a></li>
